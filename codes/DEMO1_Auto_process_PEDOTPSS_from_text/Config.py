...
bert-serving-start -model_dir uncased_L-24_H-1024_A-16
        ...
        #when inputting only pedot-pss, the val dim was set to be smaller, because only ca. 50 compounds were available (PCA cannot be done with 60-dim)
        self.CATEGORY_DIM=14
        self.VALUE_DIM=50
        ...
        #parameters to be set as problems
